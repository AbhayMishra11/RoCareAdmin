...
const gotoPreview=()=>{
  navigate('/CompleteOrdersPreview')
}

    const orders = [
        { id: 6010, date: "01-02-2026", partner: "Anurag Sign", status: "Completed", hireType: "Random", credit: 0 },
        ...
        { id: 6006, date: "01-02-2026", partner: "Anurag Sign", status: "Completed", hireType: "Random", credit: 0 },
        ...
        { id: 6003, date: "31-01-2026", partner: "Anurag Sign", status: "Completed", hireType: "Random", credit: 0 },
        ...
        <table className="min-w-full border border-gray-300 rounded-lg">
          <thead className="bg-gray-200">
            <tr className="text-left text-gray-700">
              ...
              <th className="p-2 border">Credit Required?</th>
